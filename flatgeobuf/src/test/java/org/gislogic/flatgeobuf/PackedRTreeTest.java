...
public class PackedRTreeTest {
    ...
    public void testWrite() throws IOException {
        File tmpFile = new File("src/test/resources/test/data/tmp20221102.fgb");
    ...
    public void BasicByteBuffer() throws IOException {
        ...
        File file = new File("src/test/resources/test/data/countries.fgb");
        ...
        ArrayList<PackedRTree.SearchHit> result = PackedRTree.search(bb, headerMeta.offset, (int) headerMeta.featuresCount, headerMeta.indexNodeSize, env);
    ...
    public void BasicStream() throws IOException {
        ...
        PackedRTree.SearchResult result = PackedRTree.search(stream, headerMeta.offset, (int) headerMeta.featuresCount, headerMeta.indexNodeSize, env);
